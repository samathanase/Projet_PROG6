...
public class Tuto3_toggle {
    ...
    @FXML
    private ImageView img_tuto_toggle3;
    ...
    void next_toggle(MouseEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("tuto4_toggle.fxml"));
